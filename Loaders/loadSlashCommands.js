...
module.exports = async bot => {
    ...
    setInterval(async () => {
        const Statut_Random_AutoChange = ["Ceci", "est", "un", "statut", "random"][Math.floor(Math.random() * ["Ceci", "est", "un", "statut", "random"].length)];
        bot.user.setPresence({activities: [{name: `${Statut_Random_AutoChange}`, type: ActivityType.Competing}]})
    }, 3000);
